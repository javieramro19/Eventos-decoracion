    ...
    <div class="detail-container">
      ...
      <ng-container *ngIf="!loading() && item() as evento">
        <section class="hero-card">
          ...
          <div class="actions">
            <a mat-stroked-button class="action-button action-button--soft" routerLink="/events">Volver</a>
            <a mat-raised-button color="primary" class="action-button" [routerLink]="['/events', evento.id, 'edit']">Editar</a>
            <button mat-stroked-button class="action-button action-button--danger" type="button" (click)="delete(evento)">Eliminar</button>
          </div>
        </section>
